    ...
    const handleSearchChange = (event: React.ChangeEvent<HTMLInputElement>) => {
      ...
      const filteredJobs = job.filter((j) => {
        ...
        const matchesCategory =
          ...
          selectedCategory === j.company.description; // You can adjust this logic
      ...
      <Grid container spacing={4} sx={{ maxWidth: "1200px", py: 5, px: 2 }}>
        ...
        <Grid size={{xs:12, sm:4, md:3}}>
          <FilterCard>
            ...
            <Box mt={3}>
              ...
              <Select fullWidth defaultValue="All Categories" size="small"
            ...
            <Box mt={3}>
              ...
              <TextField fullWidth size="small" placeholder="Enter location"  onChange={handleLocationChange}/>
            </Box>
          </FilterCard>
        </Grid>
        ...
        <Grid size={{xs:12,sm:8,md:9}} >
          ...
          <Grid container spacing={3}>
            {filteredJobs.map((j) => (
              <Grid  size={{xs:12 ,sm:6 ,md:4}}  key={j._id} onClick={()=>{
                navigate(`/seeker/job/${j._id}`)
              }}>
                    ...
                    <Box my={1} display="flex" gap={1} flexWrap="wrap">
                      ...
                      {/* {j.remote && (
                        <Chip
                          label="Remote"
                          size="small"
                          sx={{ bgcolor: "#ecfeff", color: "#0e7490", fontWeight: "bold" }}
                        />
                      )} */}
                    </Box>
